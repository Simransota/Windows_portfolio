...
function ThisPC() {
	...
	return (
		<>
			<Head>
				<title>Simran - This PC</title>
				<link
					rel="canonical"
					href="https://www.Simran.dev/explorer/this-pc"
				/>
				...
				{/* OpenGraph */}
				<meta property="og:title" content="Simran - This PC" />
				<meta
					property="og:url"
					content="https://www.Simran.dev/explorer/this-pc"
				/>
				<meta
