...
function Podcasts({ data }: { data: Props }) {
	...
	return (
		<>
			<Head>
				<title>Simran - Podcasts</title>
				<link
					rel="canonical"
					href="https://www.Simran.dev/explorer/favorites"
				/>
				...
				{/* OpenGraph */}
				<meta property="og:title" content="Simran - Podcasts" />
				<meta
					property="og:url"
					content="https://www.Simran.dev/explorer/podcasts"
				/>
				<meta
