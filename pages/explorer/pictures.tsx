...
function Pictures({ data }: { data: MediaType[] }) {
	...
	return (
		<>
			<Head>
				<title>Simran - Pictures</title>
				<link
					rel="canonical"
					href="https://www.Simran.dev/explorer/pictures"
				/>
				...
				{/* OpenGraph */}
				<meta property="og:title" content="Simran - Pictures" />
				<meta
					property="og:url"
					content="https://www.Simran.dev/explorer/pictures"
				/>
				<meta
